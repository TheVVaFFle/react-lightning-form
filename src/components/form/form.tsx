...
export const Form: React.SFC<FormProps> = (props: FormProps) => {
    ...
    return React.Children.map(children, (child: JSX.Element) => {
      ...
      if(type === FormComponentType.Section){
        ...
        mappedChildren = React.Children
          .map(mappedChildren, (mappedChild: JSX.Element, index: number) => {
            return FormUtility.input.enhance(mappedChild, formState, columns, index, updateCount, setUpdateCount, setFormState, handleOnSubmit)
          });
  ...
  return(
    <div id={props.id || undefined} className={FormUtility.get.classes(props.loading)}>
