    ...
    return react_1.default.Children.map(children, function(child, index) {
      ...
      if (type === FormComponentType.Section) {
        ...
        var section = child.type(child.props),
          fields = section.props.children
            .find(function(c) {
              return c && c.props.className === "section-contents";
            })
            .props.children.find(function(c) {
        ...
        if (child.props.data) {
          ...
          mappedChildren = form_1.FormUtility.map.from.children(fields);
        }
        mappedChildren = react_1.default.Children.map(mappedChildren, function(
          ...
          if (type === FormComponentType.Section) {
            ...
            return form_1.FormUtility.table.enhance(
              mappedChild,
              formState,
              columns_1,
              index,
