...
exports.Form = function(props) {
  ...
  react_2.useEffect(
    function() {
      if (props.data) {
        ...
        setMappedData(utility_1.FormUtility.map.raw.data(props.data) || []);
      } else if (props.children) {
        var section = utility_1.FormUtility.map.section.data(props.children);
        setRawData(section.data);
        setMappedData(utility_1.FormUtility.map.raw.data(section.data) || []);
      }
    },
    [props.data, errors]
  );
  ...
  var validate = function() {
    var updateErrors = function(errors) {
      var flatErrors = utility_1.FormUtility.get.errors(errors);
    ...
    return utility_1.FormUtility.validate.data(
      rawData,
      mappedData,
      validation,
      errors,
  ...
  var components = utility_1.FormUtility.map.data.to.components(
    rawData,
    mappedData,
    props.options,
    props.types,
