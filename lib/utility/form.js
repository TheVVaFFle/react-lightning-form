...
exports.RLFUtility = {
  get: {
    ...
    error: {
      message: function(item, validation, messages) {
        ...
        if (
          validationType === form_1.RLFValidationType.Required ||
          validationType === form_1.RLFValidationType.RequiredForSection
        ) {
  ...
  handle: {
    ...
    array: function(
      ...
      if (
        ...
        var handleOnChange = _.get(onChange, formattedFlatKey);
  ...
  run: {
    validation: function(fn, validateOn, value) {
      if (typeof fn === ObjectType.String) {
        if (
          fn === form_1.RLFValidationType.Required ||
          (fn === form_1.RLFValidationType.RequiredForSection &&
            validateOn !== form_1.RLFValidateOn.Form)
        ) {
